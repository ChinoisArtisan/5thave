...
- (void)setUpForContinuous:(BOOL)continuous {
    if (continuous) {
        ...
        if (self.timeline)
        {
            self.backgroundColor = [UIColor colorWithRed:45/255.0f green:46/255.0f blue:45/255.0f alpha:1];
        }
        else
        {
            self.backgroundColor = [UIColor colorWithRed:190/255.0f green:190/255.0f blue:190/255.0f alpha:1];;
        }
...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    if (buttonStyle == JGActionSheetButtonStyleDefault) {
        ...
        font = [UIFont fontWithName:@"Montserrat-Regular" size:14.0f];
       // font = [UIFont systemFontOfSize:15.0f];
        titleColor = [UIColor whiteColor];
        
        backgroundColor = [UIColor colorWithRed:23/255.0f green:23/255.0f blue:23/255.0f alpha:1];
...
- (CGRect)layoutForWidth:(CGFloat)width {
    ...
    CGFloat wspacing = kSpacing * 3.0f;
...
#pragma clang diagnostic pop
    ...
    for (UIButton *button in self.buttons) {
        ...
        button.frame = (CGRect){{wspacing, height}, {width-wspacing*2.0f, buttonHeight}};
