...
class BillingAddressViewController: UIViewController, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate, navaction{
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.titleView = NavButtonGenerator.sharedInstance.createnavtitle("BILLING ADDRESS")
    ...
    @IBAction func savePushed(sender: AnyObject) {
        if checkfield()
        {
            let vc = (storyboard!.instantiateViewControllerWithIdentifier(ShippingAddressViewControllerID) as? ShippingAddressViewController)!
